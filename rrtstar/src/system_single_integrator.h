...
namespace SingleIntegrator {
    ...
    class Trajectory {
        ...
        State *endState; 
        double totalVariation;  //Wat is this???
    ...
    public:    
         ...
         * More elaborate description
         */
        State& getEndState () {return *endState;} //definiton idr he
         ...
         * More elaborate description
         */
        State& getEndState () const {return *endState;}  //definiton idr he
	...
	/*!
	 * RGD function returns a Randomized Gradient Decent 
	 * sample state after taking input as a Random State
	 */
	int RGD(State &rstout);
